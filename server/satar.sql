...
--
-- Host: localhost
-- Generation Time: Aug 31, 2013 at 11:12 AM
...
CREATE TABLE IF NOT EXISTS `satar` (
  ...
  PRIMARY KEY (`index`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='contains raw values from the SATAR nodes' AUTO_INCREMENT=45908 ;
...
CREATE TABLE IF NOT EXISTS `satar_users` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Table for all registered participants. ' AUTO_INCREMENT=728 ;
